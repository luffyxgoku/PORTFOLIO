...
//import "./Home.css";
import profileimage from "./Npic1.jpg";
      ...
      <section id="home">
        ...
        <div className="pt-4 pb-4">
          <div className="flex flex-wrap justify-center m-8">
            <h1 className="text-black underline underline-offset-8 decoration-sky-950 ml-10 sm:ml-0">
              Welcome to my World
            </h1>
          ...
          <div className="flex flex-wrap gap-4 justify-center m-4">
            <div className="border-0 text-center w-[350px] h-[350px] pt-8 rounded-xl text-white bg-sky-950 hover:bg-black hover:rotate-6 hover:transform transition-transform duration-300">
              <h2 className="pb-3">About Me</h2>
              <p>
                Hi, I'm <strong>Sami</strong> ! I'm a passionate web developer
                with a keen interest in creating dynamic and user-friendly
                websites.
              </p>
              <p>
                On this page, you'll find my latest projects and resources that
                showcase my journey and expertise in web development.
              </p>

              <p
                onClick={() => (window.location.href = "#about")}
                className="cursor-pointer text-lg  text-sky-300 rounded hover:text-white transition-colors duration-200 no-underline"
              >
                Know More...
              </p>
            </div>
            ...
            <div className="border-0 text-center w-[350px] h-[350px] pt-8 rounded-xl text-white bg-sky-950 hover:bg-black hover:-rotate-6 hover:transform transition-transform duration-300">
              ...
              <p>
                Don't hesitate to get in touch – let's create something amazing
                together!
              </p>
